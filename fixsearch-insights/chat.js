  ...
  function promptForKey() {
    return new Promise(function (resolve) {
      ...
      keyDiv.innerHTML = [
        ...
        '<br.�M�<span style="font-size:11px;opacity:0.7;".�M�Stored in sessionStorage only — cleared when tab closes.</span>',
        '</div>',
        ...
        'color:#e8eaf0;padding:6px 8px;font-size:12px;font-family:monospace;outline:none;" /.�M�',
